	...
	<div id="menu">
		...
		<div class="search-form main-content-card">
			<el-form label-width="120px" :inline="true" :mode="searchForm" ref="searchFormRef">
				<el-row justify="space-evenly">
					...
					<el-col :lg="8" :md="12" :sm="24">
						<el-form-item size="large" label="菜单名称">
		...
		<div class="user-list main-content-card">
			<el-row class="header" justify="space-between">
				...
				<div class="right">
					<el-button type="primary" @click="addUserClick">创建菜单</el-button>
			...
			<el-table :data="userList" style="width: 100%" border row-key="id">
				...
				<el-table-column prop="icon" label="菜单icon" width="290" />
				<el-table-column prop="enable" label="按钮权限" width="100">
...
import { requestMenuList } from "@/apis/system/system";
...
async function _requestUserList(queryInfo) {
	let res = await requestMenuList({ ...queryInfo });
