	...
	<div id="department">
		...
		<div class="search-form main-content-card">
			<el-form label-width="120px" :inline="true" :mode="searchForm" ref="searchFormRef">
				<el-row justify="space-evenly">
					...
					<el-col :lg="8" :md="12" :sm="24">
						<el-form-item size="large" label="部门名称">
							<el-input placeholder="请输入部门名称" v-model="searchForm.name" />
						</el-form-item>
					</el-col>
					<el-col :lg="8" :md="12" :sm="24">
						<el-form-item size="large" label="部门领导">
		...
		<div class="user-list main-content-card">
			...
			<el-table :data="userList" style="width: 100%" border>
				...
				<el-table-column prop="parentId" label="权限介绍" width="100" />
				<el-table-column prop="leader" label="上级部门" width="150" />
...
import { requestDepartmentList} from "@/apis/system/system";
...
async function _requestUserList(queryInfo) {
	let res = await requestDepartmentList({ ...queryInfo });
