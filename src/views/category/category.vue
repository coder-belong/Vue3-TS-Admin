	...
	<div id="category">
		...
		<div class="search-form main-content-card">
			<el-form label-width="120px" :inline="true" :mode="searchForm" ref="searchFormRef">
				<el-row justify="space-evenly">
					...
					<el-col :lg="8" :md="12" :sm="24">
						<el-form-item size="large" label="分类名称">
							<el-input placeholder="请输入分类名称" v-model="searchForm.name" />
						</el-form-item>
					</el-col>
		...
		<div class="user-list main-content-card">
			<el-row class="header" justify="space-between">
				<div class="left">
					<h2 class="title">类别列表</h2>
				</div>
				<div class="right">
					<el-button type="primary" @click="addUserClick">创建类别</el-button>
...
import {requestGoodsCategoryList} from "@/apis/goods/goods";
...
async function _requestUserList(queryInfo) {
	let res = await requestGoodsCategoryList({ ...queryInfo });
